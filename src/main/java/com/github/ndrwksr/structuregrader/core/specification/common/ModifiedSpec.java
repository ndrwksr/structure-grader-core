...
import com.github.ndrwksr.structuregrader.core.property.Modified;
...
public class ModifiedSpec<MODIFIED extends Modified> implements ItemVisitor<MODIFIED> {
	...
	public String getSpecDescription() {
		return "A spec for any element that implements Modified, such as classes, fields, methods, etc.";
	}
