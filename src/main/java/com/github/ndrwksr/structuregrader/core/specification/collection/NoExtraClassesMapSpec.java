...
import com.github.ndrwksr.structuregrader.core.visitor.ClassHierarchyVisitor;
import com.github.ndrwksr.structuregrader.core.visitor.ClassHierarchyVisitorFactory;
...
public class NoExtraClassesMapSpec extends NoExtraMapSpec<ClassWrapper> implements ClassHierarchyVisitor {
	...
	public String getSpecDescription() {
		return "A specification that specifies a maximum set of classes " +
				"in a package or inner classes of a declaring class.";
	}
