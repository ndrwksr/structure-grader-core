...
public class CardGroup
{
	...
	/**
	 * Shuffles the deck of cards. <br>
	 * 
	 * Currently this is not called by any other method in the program <br>
	 * Creates a Random object and and calls {@link CardGroup#shuffle(Random)}
	 */
	public void shuffle()
	{
	 ...
	 * Shuffles the deck of cards. <br>
	 * 
	 * Creates a Random object with the given seed and calls {@link CardGroup#shuffle(Random)}
